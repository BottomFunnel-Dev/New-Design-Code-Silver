                    ...
                    <Tab eventKey="order" title="Services">
                        <div className='infoContainer'>
                           <ul className='text-start'>
                                ...
                                <li><strong>Lifetime Warranty:</strong> Coverage for repairs and maintenance.</li>
                                <li><strong>Free Cleaning:</strong>Free Cleaning: Periodic professional cleaning services.</li>
