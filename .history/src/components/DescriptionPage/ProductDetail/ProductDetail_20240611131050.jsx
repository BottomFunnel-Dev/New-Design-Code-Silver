                    ...
                    <Tab eventKey="order" title="Services">
                        <div className='infoContainer'>
                           <ul className='text-start'>
                                <li><strong>Free Resizing:</strong>  Complimentary resizing services within the first year.</li>
                                <li><strong>Free Resizing:</strong>Lifetime Warranty: Coverage for repairs and maintenance.</li>
                                <li><strong>Free Resizing:</strong>Free Cleaning: Periodic professional cleaning services.</li>
                                <li><strong>Free Resizing:</strong>Engraving: Custom engraving options for personalization.</li>
                                <li><strong>Free Resizing:</strong>Appraisal: Professional valuation and certification.</li>
                                <li><strong>Free Resizing:</strong>Gift Packaging: Elegant, complimentary gift wrapping.</li>
                                <li><strong>Free Resizing:</strong>Free Shipping: Complimentary insured shipping on all orders.</li>
                           </ul>
                        </div>
                    </Tab>
                </Tabs>
