...
import { CartContext } from '../../context'; // Update the import path accordingly
      ...
      <div className='container p-0 mt-3 checkoutMainBox'>
        ...
        <div className='col-lg-5 checkoutDetails p-4'>
          ...
          <div className='d-flex justify-content-between mt-4'>
            ...
            <p className='checkoutFontColor m-0'>₹{calculateTotal()}</p>
          </div>
          ...
          <div className='d-flex justify-content-between'>
            ...
            <h5 className='checkoutFontColor'>₹{calculateTotal()}</h5>
          </div>
