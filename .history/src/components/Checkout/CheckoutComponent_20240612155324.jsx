                ...
                <div className='container d-flex p-0 mt-3'>
                    ...
                    <div className='col-lg-7 border border-dark d-flex text-start' style={{height:"250px"}}>
                        ...
                        <div className='col-lg-8 border border-dark'>
                            ...
                            <p className='checkoutSubHeading mt-0'> <strong>14 Days</strong> Return Available</p>
                            <p className='checkoutSubHeading'> <img src="/img/Checkout/check_circle.png" alt="" className='checkoutIconSizes'/> Delivery between <strong>18 April - 20 April</strong></p>
                        </div>
                    </div>
