                ...
                <div className="filterSortDiv">
                    ...
                    <div class="modal" id="exampleModal" tabindex="-1" aria-labelledby="exampleModal" aria-hidden="true">
                                    <div class="modal-dialog">
                                        <div class="modal-content" style={{backgroundColor:"#FBF5EA"}}>
                                            ...
                                            <div class="modal-body mx-3">
                                                ...
                                                <div class="mt-1 w-100 p-0">
                                                    <button type="reset" class="listFilterclearBtn">CLEAR ALL</button>
                                                    <button type="submit" class="listSortsubmitBtn">Apply</button>
                                                </div>
                                        </div>
                                    </div>
                    </div>
                    ...
                    <div class="modal" id="sortModal" tabindex="-1" aria-labelledby="sortModal" aria-hidden="true">
                                    <div class="modal-dialog">
                                        <div class="modal-content" style={{backgroundColor:"#FBF5EA"}}>
                                            <div class="modal-header">
                                                <h3 class="modal-title mx-3 mainTextColor" id="sortModal">Sort By</h3>
                                                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                            </div>
                                            ...
                                            <div class="modal-body mx-3">
                                                <div class="filter-section mt-2 ">
                                                    ...
                                                    <h6 className="listDataitemscolor">Price: Low to High</h6>
                                                    <h6 className="listDataitemscolor">New Arrival</h6>
                                                    <h6 className="listDataitemscolor">Best Sellers</h6>
                                                    <h6 className="listDataitemscolor">Best Matches</h6>
                                                </div>
                                            </div>
            ...
            <div className="container m-auto row row-cols-lg-4 row-cols-md-2 row-cols-1 g-4">
                <div className="col">
                    <div className="card h-100 rounded-0 listDatasCards">
                        ...
                        <img src="/img/Homepage/WishlistIcon.png" alt="" className="wishlistIconlistData" onClick={handleWishlistClick} />
                ...
                <div className="col">
                    <div className="card h-100 rounded-0 listDatasCards">
                        <img src="/img/Homepage/BangleTS.png" className="rounded-0 card-img-top sellerposition" alt="..." a/>
                        <img src="/img/Homepage/WishlistIcon.png" alt="" className="wishlistIconlistData" onClick={handleWishlistClick} />
                        <div className="card-footer listDataCardContent">
