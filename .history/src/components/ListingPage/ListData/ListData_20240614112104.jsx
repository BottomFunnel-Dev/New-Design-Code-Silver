        ...
        <div className="container my-5">
            <div className='descPageHeading px-4'>
                ...
                <div className="filterSortDiv">
                    ...
                    <div className="listFilterButton" data-bs-toggle="modal" data-bs-target="#examsortModalpleModal">
                        <img src="/img/listingPage/filter.png" alt="" />
                        <p className="m-0">Sort By</p>
                    </div>

                    <div class="modal" id="sortModal" tabindex="-1" aria-labelledby="exampleModal" aria-hidden="true">
                                    <div class="modal-dialog">
                                        <div class="modal-content" style={{backgroundColor:"#FBF5EA"}}>
                                            <div class="modal-header">
                                                <h3 class="modal-title mx-3 mainTextColor" id="exampleModal">Filter</h3>
