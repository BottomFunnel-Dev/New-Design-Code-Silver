                    ...
                    <div className='col-lg-6'>
                        <div className='supportBoxes d-flex mt-3'>
                            ...
                            <div className='col-lg-11 py-4 px-4'>
                                ...
                                <p className='m-0 smallfont'>Phone number +45 53691550</p>
                                <p className=''>The phones are open from 9am – 5pm. Time zone Glitter City (GMT+2)</p>
                            </div>
                        </div>
                        ...
                        <div className='supportBoxes d-flex mt-3'>
                            ...
                            <div className='col-lg-11 py-4 px-4'>
                                ...
                                <p className='m-0 '>E-mail us at customercare@thelotusjeweller.com</p>
                                <p className=''>We aim to answer you as soon as possible and always within 48 hours</p>
                            </div>
                        </div>
                        ...
                        <div className='supportBoxes d-flex mt-3'>
                            ...
                            <div className='col-lg-11 py-4 px-4'>
                                ...
                                <p className='m-0 '>122, Street</p>
                                <p className=''>srimrr.nna Glitter Cit" ccorty. ZO 98765</p>
                            </div>
                        </div>
                    </div>
                </div>
