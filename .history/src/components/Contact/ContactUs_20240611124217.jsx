                ...
                <div className='conatiner row'>
                    ...
                    <div className='col-lg-6 border border-dark'>
                        <div className='supportBoxes d-flex'>
                            ...
                            <div className='col-lg-11 border boder-dark'>
                                <h4 className='text-start p-0 m-0'>Phone support</h4>
                                <p className='p-0 m-0'>Phone number +45 53691550</p>
                                <p className='p-0 m-0'>The phones are open from 9am – 5pm. Time zone Glitter City (GMT+2)</p>
                            </div>
                        </div>
                    </div>
                </div>
