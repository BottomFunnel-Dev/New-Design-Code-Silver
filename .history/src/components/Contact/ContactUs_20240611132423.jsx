                ...
                <div className='conatiner row'>
                    ...
                    <div className='col-lg-6'>
                        <div className='supportBoxes d-flex mt-3'>
                            ...
                            <div className='col-lg-11 py-4 px-2'>
                                <h5 className='text-start'>Phone support</h5>
                                <p className='m-0 fs-6'>Phone number +45 53691550</p>
                                <p className='fs-6'>The phones are open from 9am – 5pm. Time zone Glitter City (GMT+2)</p>
                            </div>
                        </div>
                        ...
                        <div className='supportBoxes d-flex mt-3'>
                            ...
                            <div className='col-lg-11 py-4 px-2'>
                                ...
                                <p className='m-0 fs-6'>E-mail us at customercare@thelotusjeweller.com</p>
                                <p className='fs-6'>We aim to answer you as soon as possible and always within 48 hours</p>
                            </div>
                        </div>

                        <div className='supportBoxes d-flex mt-3'>
                            <div className='col-lg-1'>
                                <img src="/img/Contact/locationbg.png" alt=""  className='my-4'/>
                            </div>
                            <div className='col-lg-11 py-4 px-2'>
                                <h5 className='text-start'>Location
122, Street
srimrr.nna Glitter Cit" ccorty. ZO 98765</h5>
                                <p className='m-0 fs-6'>122, Street</p>
                                <p className='fs-6'>srimrr.nna Glitter Cit" ccorty. ZO 98765</p>
                            </div>
                        </div>
                    </div>
                </div>
