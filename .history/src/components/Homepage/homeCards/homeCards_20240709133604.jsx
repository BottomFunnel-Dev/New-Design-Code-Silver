                ...
                <div className="col">
                    ...
                    <div className="card h-100 rounded-0 cardscontainer">
                        ...
                        <div className="card-footer">
                            <h6 className="text-dark"><a href="/product-list" className="text-dark text-decoration-none">Rings</a></h6>
                        </div>
                    </div>
                </div>
                <div className="col">
                    <div className="card h-100 rounded-0 cardscontainer">
                        ...
                        <div className="card-footer">
                            <h6 className="text-dark"><a href="/product-list" className="text-dark text-decoration-none">Pendants</a></h6>
                        </div>
                    </div>
                </div>
                <div className="col">
