                ...
                <div className="col">
                    <div className="card h-100 rounded-0 cardscontainer">
                        ...
                        <div className="card-footer">
                            <h6 className="text-dark"><a href="/product-list">Rings</a></h6>
                        </div>
                    </div>
                </div>
                <div className="col">
                    <div className="card h-100 rounded-0 cardscontainer">
                        ...
                        <div className="card-footer">
                            <h6 className="text-dark"><a href="/product-list">Pendants</a></h6>
                        </div>
                    </div>
                </div>
                <div className="col">
                    <div className="card h-100 rounded-0 cardscontainer">
                        ...
                        <div className="card-footer">
                            <h6 className="text-dark"><a href="/product-list">Bangles</a></h6>
                        </div>
                    </div>
                </div>
                <div className="col">
                    <div className="card h-100 rounded-0 cardscontainer">
                        ...
                        <div className="card-footer">
                            <h6 className="text-dark"><a href="/product-list" className="text-white text-decoration-none">Earrings</a></h6>
                        </div>
                    </div>
                </div>
            </div>
