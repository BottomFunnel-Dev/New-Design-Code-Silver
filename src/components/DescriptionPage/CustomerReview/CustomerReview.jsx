                ...
                <div className='container d-flex reviewBoxContainer'>
                    ...
                    <div className="review-card my-4">
                        <div className="user-info">
                            ...
                            <div className="user-details">
                                <h5 className="user-name">David L.</h5>
                                <p>5 months ago</p>
                            </div>
                        </div>
                        ...
                        <div className="review-content">
                            ...
                            <p>"Finding the perfect engagement ring online was daunting, but Lotus Jewelry made it easy. Their customer service was fantastic - they helped me choose the right diamond and setting within my budget. My fiancé absolutely loves it!"</p>
                        </div>
                    </div>
